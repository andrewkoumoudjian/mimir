			...
			<div className="flex flex-col items-center">
				...
				<div className="text-center mb-6 space-y-2">
					...
					<p className="text-[#606060] text-sm">
						Try another transaction ID, card, merchant, signal, or filter.
					</p>
				</div>
	...
	return (
		<div className="absolute w-full h-[calc(100vh-300px)] top-0 left-0 flex items-center justify-center z-20">
			<div className="text-center max-w-sm mx-auto flex flex-col items-center justify-center">
				<h2 className="text-xl font-medium mb-2">No transactions loaded</h2>
				<p className="text-sm text-[#878787] mb-6">
					Import transactions.csv to score all 1,000 rows and build the fraud
					review queue.
				</p>
		...
		<div className="absolute w-full h-[calc(100vh-300px)] top-0 left-0 flex items-center justify-center z-20">
			<div className="text-center max-w-sm mx-auto flex flex-col items-center justify-center">
				...
				<p className="text-sm text-[#878787]">
					Every flagged transaction has a reviewer decision. New detector
