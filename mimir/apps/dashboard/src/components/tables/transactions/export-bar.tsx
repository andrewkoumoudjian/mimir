...
const ACCOUNTING_PROVIDERS = [
	{ id: "xero", name: "Review archive" },
	{ id: "quickbooks", name: "Case system" },
	{ id: "fortnox", name: "Compliance store" },
] as const;
...
export function ExportBar() {
	...
	useEffect(() => {
		const providerName = exportData?.providerName ?? "review destination";
					...
					>
						...
						<div className="relative mx-2 md:mx-0 h-12 justify-between items-center flex pl-4 pr-2">
							<span className="text-sm">
								{exportingCount !== null
									? `${displayCount} writing CSV`
									: displayCount > 0
										? `${displayCount} selected`
										: "Select flags to export"}
							</span>
												...
												{connectedProviders.map((provider) => {
													...
													return (
														...
														>
															...
															Send to {PROVIDER_NAMES[provider.app_id]}
														</DropdownMenuItem>
													);
												})}
