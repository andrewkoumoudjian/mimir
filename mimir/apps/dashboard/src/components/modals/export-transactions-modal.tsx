...
const exportSettingsSchema = z
	...
	.refine(
		(data) => {
			if (data.sendEmail) {
				if (!data.reviewerEmail || data.reviewerEmail.trim() === "") {
					return false;
				}
				return z.string().email().safeParse(data.reviewerEmail.trim()).success;
			}
			return true;
		},
		{
			...
			<DialogContent className="max-w-[500px]">
				<div className="p-4">
					<DialogHeader className="mb-6">
						<DialogTitle>Export Updated Transactions</DialogTitle>
						<DialogDescription>
							Export <NumberFlow value={totalCount} /> reviewed flag
							{totalCount !== 1 ? "s" : ""} to the updated CSV package.
						</DialogDescription>
					</DialogHeader>
											...
											<div className="flex items-center justify-between">
												<div className="space-y-0.5">
													...
													<p className="text-xs text-[#878787]">
														Include fraud score, reasons, and review status
													</p>
												</div>
												<FormControl>
													<Switch
										...
										<FormItem>
											<div className="flex items-center justify-between">
												<div className="space-y-0.5">
													...
													<p className="text-xs text-[#878787]">
														Include a reviewer-friendly workbook
													</p>
												</div>
												<FormControl>
													<Switch
										...
										<FormItem>
											<div className="flex items-center justify-between">
												<div className="space-y-0.5">
													...
													<p className="text-xs text-[#878787]">
														Email the export package to a reviewer
													</p>
												</div>
												<FormControl>
													<Switch
