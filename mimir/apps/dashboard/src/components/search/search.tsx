...
const formatGroupName = (name: string): string | null => {
	switch (name) {
		...
		case "tracker_project":
			return "Hypotheses";
		case "transaction":
			return "Transactions and signals";
		case "inbox":
			return "Evidence";
	...
	return (
		...
		>
			<div className="border-b border-border relative">
				<CommandInput
					ref={searchInputRef}
					placeholder="Search transaction, card, IP, device, merchant..."
